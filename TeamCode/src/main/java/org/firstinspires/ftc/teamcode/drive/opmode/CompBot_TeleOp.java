...
public class CompBot_TeleOp extends BaseClass_PP {
...
//            updatePoseStrafe();
            ...
            //Gamepad 1 Variables
           // waitForStart();
            double leftY1 = (gamepad1.left_stick_y) * powerMultiplier; //front/back
            double rightX1 = (gamepad1.right_stick_x) * powerMultiplier;// r for rotate
            double leftX1 = (gamepad1.left_stick_x);//strafe
