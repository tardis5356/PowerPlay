...
public class R2V2_GrabFromStackCommand extends SequentialCommandGroup {
    ...
    public R2V2_GrabFromStackCommand(SampleMecanumDrive_R2V2 drive, Lift lift, Arm arm, Wrist wrist, Gripper gripper, Coffin coffin, int stackIndex, boolean isBlue) {
