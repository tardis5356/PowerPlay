...
@TeleOp(name = "Gen1_Teleop_Test")
public class Gen1_Teleop_Test extends CommandOpMode {

    private DcMotorEx mFR, mFL, mBR, mBL, mL;
...
//        schedule(new BulkCacheCommand(hardwareMap));
    ...
    public void run() {
        ...
        double twory = gamepad2.right_stick_y;
