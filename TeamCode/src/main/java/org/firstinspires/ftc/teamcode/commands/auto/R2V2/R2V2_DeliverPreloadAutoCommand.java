...
public class R2V2_DeliverPreloadAutoCommand extends SequentialCommandGroup {
    ...
    public R2V2_DeliverPreloadAutoCommand(SampleMecanumDrive_R2V2 drive, Lift lift, Arm arm, Wrist wrist, Gripper gripper, BatWing batwing, int stackIndex, boolean isBlue) {
        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                new WaitCommand(500),
                                new RobotToStateCommand(lift, arm, wrist, gripper, batwing, LIFT_INTAKE_R2V2, 0, "intake")
                        )
                        //new InstantCommand(gripper::open)
                )
        );
