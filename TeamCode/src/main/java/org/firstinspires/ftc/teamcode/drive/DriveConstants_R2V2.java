 ...
 */
@Config
public class DriveConstants_R2V2 {
    ...
    public static double TRACK_WIDTH = 14;//11.22;//10.83;//9.43; // in, 9.09
     ...
     * empirically tuned.
     */
    public static double kV = 0.0175;//0.018//1.0 / rpmToVelocity(MAX_RPM);
    public static double kA = 0.0035;//0.004
