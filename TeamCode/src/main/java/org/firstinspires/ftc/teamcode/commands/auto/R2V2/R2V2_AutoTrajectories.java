...
public class R2V2_AutoTrajectories {
    ...
    */
    ...
    public static final Pose2d blue_PreloadPolePos = new Pose2d(-29.25, 4.5, Math.toRadians(160));

    public static final Pose2d blue_MainPolePos = new Pose2d(-6, 23.5, Math.toRadians(212));
    ...
    public static final Pose2d blue_StackPos = new Pose2d(-59.5, 14, Math.toRadians(180)); // x -58

    //red auto positions
    public static final Pose2d red_StartPos = new Pose2d(36, 64, Math.toRadians(90));

    public static final Pose2d red_PreloadPolePos = new Pose2d(30, 4, Math.toRadians(20));

    public static final Pose2d red_MainPolePos = new Pose2d(5, 20, Math.toRadians(-32));
    ...
    public static final Pose2d red_StackPos = new Pose2d(59, 14, Math.toRadians(0)); // x -58
