...
public class R2V2_AutoTrajectories {
    ...
    */
    ...
    public static final Pose2d blue_PreloadPolePos = new Pose2d(-23, 5.5, Math.toRadians(130));//-35
//    public static final Pose2d blue_MainPolePos = new Pose2d(-5, 22.5, Math.toRadians(212));
    public static final Pose2d blue_MedPolePos = new Pose2d(-31, 20, Math.toRadians(212));
//    public static final Pose2d blue_StackFarWaypointPos = new Pose2d(-38, 11, Math.toRadians(180));
    public static final Pose2d blue_StackCloseWaypointPos = new Pose2d(-50, 11, Math.toRadians(180));
    public static final Pose2d blue_StackPos = new Pose2d(-61, 11, Math.toRadians(180));//-63
...
//    public static final Pose2d red_StackPos = new Pose2d(56, 14, Math.toRadians(0)); // x -58
    ...
    public static final Pose2d red_PreloadPolePos = new Pose2d(31, 1.5, Math.toRadians(40));
...
//    public static final Pose2d red_StackFarWaypointPos = new Pose2d(38, 11, Math.toRadians(0));
    public static final Pose2d red_StackCloseWaypointPos = new Pose2d(50, 10, Math.toRadians(0));
    public static final Pose2d red_StackPos = new Pose2d(62.5, 10, Math.toRadians(0));

    public static TrajectorySequence blue_StartToPreloadPole, blue_PreloadPoleToStackWaypoint, blue_PreloadPoleToStackCloseWaypoint, blue_MainPoleToStackWaypoint, blue_MedPoleToStackWaypoint, blue_StackWaypointToStack, blue_StackCloseWaypointToStack, blue_StackToStackWaypoint, blue_StackWaypointToMainPole,  blue_StackCloseWaypointToMedPole,
    ...
    red_StackCloseWaypointToMedPole, red_StackWaypointToMedPole;
...
//                        .build();
        ...
        blue_PreloadPoleToStackCloseWaypoint =
                drive.trajectorySequenceBuilder(blue_PreloadPolePos)
                        .back(-0.10)
                        .splineToLinearHeading(blue_StackCloseWaypointPos, Math.toRadians(0), SampleMecanumDrive_R2V2.getVelocityConstraint(30, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .build();
...
//                        .build();
        blue_StackCloseWaypointToMedPole =
                drive.trajectorySequenceBuilder(blue_StackCloseWaypointPos)
                        .back(0.10)
...
//                        .lineTo(new Vector2d(36, 20))
                        ...
                        .splineToConstantHeading(new Vector2d(36, 7), Math.toRadians(270), SampleMecanumDrive_R2V2.getVelocityConstraint(30, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .lineTo(new Vector2d(36, 20), SampleMecanumDrive_R2V2.getVelocityConstraint(30, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .splineToLinearHeading(red_PreloadPolePos, Math.toRadians(200), SampleMecanumDrive_R2V2.getVelocityConstraint(20, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .setReversed(false)
                        .build();
//
...
//                        .build();
        ...
        red_PreloadPoleToStackCloseWaypoint =
                drive.trajectorySequenceBuilder(red_PreloadPolePos)
                        .back(-0.10)
                        .splineToLinearHeading(red_StackCloseWaypointPos, Math.toRadians(0), SampleMecanumDrive_R2V2.getVelocityConstraint(30, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .build();
//
...
//                        .build();
        ...
        red_StackCloseWaypointToMedPole =
                drive.trajectorySequenceBuilder(red_StackCloseWaypointPos)
                        .back(0.10)
                        .splineToSplineHeading(red_MedPolePos, Math.toRadians(150), SampleMecanumDrive_R2V2.getVelocityConstraint(30, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .build();
