...
public class R2V2_AutoTrajectories {
    ...
    */
    ...
    public static final Pose2d blue_MedPolePos = new Pose2d(-30, 20, Math.toRadians(212));
...
//    public static final Pose2d red_StackPos = new Pose2d(56, 14, Math.toRadians(0)); // x -58
    ...
    public static final Pose2d red_MedPolePos = new Pose2d(31, 16, Math.toRadians(332));
    public static final Pose2d red_StackFarWaypointPos = new Pose2d(38, 11, Math.toRadians(0));
    public static final Pose2d red_StackCloseWaypointPos = new Pose2d(50, 14, Math.toRadians(0));
    public static final Pose2d red_StackPos = new Pose2d(63, 12, Math.toRadians(0));
...
//                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
//                        .lineTo(new Vector2d(36, 20))
                        .lineTo(new Vector2d(39.5, 63), SampleMecanumDrive_R2V2.getVelocityConstraint(50, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .splineToConstantHeading(new Vector2d(36, 7), Math.toRadians(270), SampleMecanumDrive_R2V2.getVelocityConstraint(60, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .splineToLinearHeading(red_PreloadPolePos, Math.toRadians(250), SampleMecanumDrive_R2V2.getVelocityConstraint(40, DriveConstants_R2V2.MAX_ANG_VEL, DriveConstants_R2V2.TRACK_WIDTH),
                                SampleMecanumDrive_R2V2.getAccelerationConstraint(DriveConstants_R2V2.MAX_ACCEL))
                        .setReversed(false)
                        .build();
//
