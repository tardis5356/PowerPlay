...
public class BotPositions {
    ...
    public static int LIFT_INTAKE_AUTO_R2V2 = 25, LIFT_INTAKE_R2V2 = -10, LIFT_TRAVEL_R2V2 = -10, LIFT_LOW_JUNCTION_R2V2 = 340, LIFT_MEDIUM_JUNCTION_R2V2 = 770, LIFT_HIGH_JUNCTION_R2V2 = 1130, AUTO_LIFT_HIGH_JUNCTION_R2V2 = 1100;//1175
...
//public static int[] STACK_POSITIONS_R2V2 = {-10, 0, 65, 130, 170, 200};//0 = bottom cone, 4 = top cone EXC CHAMPS
    public static int[] STACK_POSITIONS_R2V2 = {-10, 75, 130, 200, 240, 285};//0 = bottom cone, 4 = top cone MTI SUBMISSION

    public static double LIFT_p_R2V2 = 0.01, LIFT_i_R2V2 = 0, LIFT_d_R2V2 = 0.0001;

    public static double ARM_INIT_R2V2 = 0.565, ARM_INTAKE_R2V2 = 0.65, ARM_AUTO_INTAKE_WAYPOINT_R2V2 = 0.60, ARM_DELIVERY_R2V2 = 0.4, ARM_TRAVEL_R2V2 = 0.53, ARM_STORAGE_R2V2 = 0.5, ARM_AUTO_END_R2V2 = 0.48; //old deliver 0.365
