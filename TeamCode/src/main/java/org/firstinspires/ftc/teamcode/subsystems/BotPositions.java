...
public class BotPositions {
    ...
    public static int LIFT_FULL_RETRACTION_R2V2 = 0, LIFT_INTAKE_AUTO_R2V2 = 25, LIFT_INTAKE_R2V2 = 10, LIFT_TRAVEL_R2V2 = 10, LIFT_LOW_JUNCTION_R2V2 = 350, LIFT_MEDIUM_JUNCTION_R2V2 = 740, LIFT_HIGH_JUNCTION_R2V2 = 1100;//1175

    public static int[] STACK_POSITIONS_R2V2 = {10, 80, 110, 130, 160};//0 = bottom cone, 4 = top cone

    public static double LIFT_p_R2V2 = 0.05, LIFT_i_R2V2 = 0, LIFT_d_R2V2 = 0.001;

    public static double ARM_INIT_R2V2 = 0.55, ARM_INTAKE_R2V2 = 0.64, ARM_DELIVERY_R2V2 = 0.39, ARM_TRAVEL_R2V2 = 0.53;

    public static double WRIST_INIT_R2V2 = 0.78, WRIST_INTAKE_R2V2 = 0.35, WRIST_DELIVERY_R2V2 = 0.9, WRIST_TRAVEL_R2V2 = 0.3;
