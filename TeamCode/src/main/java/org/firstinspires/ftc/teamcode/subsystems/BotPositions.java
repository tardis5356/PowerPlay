...
//    public static int[] STACK_POSITIONS_R2V2 = {-10, 65, 85, 140, 180, 210};//0 = bottom cone, 4 = top cone
    ...
    public static double ARM_INIT_R2V2 = 0.55, ARM_INTAKE_R2V2 = 0.64, ARM_AUTO_INTAKE_WAYPOINT_R2V2 = 0.60, ARM_DELIVERY_R2V2 = 0.365, ARM_TRAVEL_R2V2 = 0.53, ARM_STORAGE_R2V2 = 0.5, ARM_AUTO_END_R2V2 = 0.48;
    ...
    public static double BATWING_DEPLOYED_R2V2 = 0.58, BATWING_RETRACTED_R2V2 = 0.75, BATWING_STORAGE_R2V2 = 0.2, BATWING_DEPLOYED_LOW_JUNCTION_R2V2 = 0.62;
}
