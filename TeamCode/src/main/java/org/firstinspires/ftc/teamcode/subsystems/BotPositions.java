...
public class BotPositions {
    ...
    public static int LIFT_INTAKE_AUTO_R2V2 = 25, LIFT_INTAKE_R2V2 = -10, LIFT_TRAVEL_R2V2 = -10, LIFT_LOW_JUNCTION_R2V2 = 320, LIFT_MEDIUM_JUNCTION_R2V2 = 715, LIFT_HIGH_JUNCTION_R2V2 = 1100, AUTO_LIFT_HIGH_JUNCTION_R2V2 = 1100;//1175

//    public static int[] STACK_POSITIONS_R2V2 = {-10, 65, 85, 140, 180, 210};//0 = bottom cone, 4 = top cone
    public static int[] STACK_POSITIONS_R2V2 = {-10, 65, 75, 130, 170, 200};//0 = bottom cone, 4 = top cone

    public static double LIFT_p_R2V2 = 0.01, LIFT_i_R2V2 = 0, LIFT_d_R2V2 = 0.0001;

    public static double ARM_INIT_R2V2 = 0.55, ARM_INTAKE_R2V2 = 0.64, ARM_AUTO_INTAKE_WAYPOINT_R2V2 = 0.60, ARM_DELIVERY_R2V2 = 0.38, ARM_TRAVEL_R2V2 = 0.53, ARM_STORAGE_R2V2 = 0.5, ARM_AUTO_END_R2V2 = 0.48;

    public static double WRIST_INIT_R2V2 = 0.78, WRIST_INTAKE_R2V2 = 0.35, WRIST_AUTO_INTAKE_WAYPOINT_R2V2 = 0.1, WRIST_DELIVERY_R2V2 = 0.95, WRIST_TRAVEL_R2V2 = 0.3;

    public static double GRIPPER_OPEN_R2V2 = 0.5, GRIPPER_CLOSED_R2V2 = 0.2, GRIPPER_OPEN_AUTO_R2V2 = 0.6;

    public static double BEACON_ARM_LOAD_R2V2 = 1, BEACON_ARM_STORAGE_R2V2 = 0.6, BEACON_ARM_DELIVERY_R2V2 = 0.8;

    public static double BATWING_DEPLOYED_R2V2 = 0.62, BATWING_RETRACTED_R2V2 = 0.7, BATWING_STORAGE_R2V2 = 0.2, BATWING_DEPLOYED_LOW_JUNCTION_R2V2 = 0.66;
}
