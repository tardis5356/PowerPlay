...
public class BotPositions {
    ...
    public static int LIFT_INTAKE_AUTO_R2V2 = 25, LIFT_INTAKE_R2V2 = -10, LIFT_TRAVEL_R2V2 = -10, LIFT_LOW_JUNCTION_R2V2 = 320, LIFT_MEDIUM_JUNCTION_R2V2 = 700, LIFT_HIGH_JUNCTION_R2V2 = 1100, AUTO_LIFT_HIGH_JUNCTION_R2V2 = 1075;//1175

    public static int[] STACK_POSITIONS_R2V2 = {-10, 35, 85, 140, 210};//0 = bottom cone, 4 = top cone
